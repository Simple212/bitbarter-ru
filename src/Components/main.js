...
const Main1= ({reverse,value2,change1,value3,value4,value5,value6,value7,value10,value11,changetodoge,changetoltc,changetobtc,changetodoge4,changetoltc4,changetobtc4,event1,value500,from1,to1,value71,value72,value73,value74,value75,value76,call,value1500,value1006,backtohome,changetoxmr,value738,changetoxmr2,value739,value740,value741,changetobnb1,changetobnb2,value750,value751,changetobch1,changetobch2,changetotrx1,value760,value761,value7610,value501,value10070,value1600,changetorose1,event105,changetorose2,changetodash1,send2,first56,first66,changetoavax1,changetoada1,changetovet1,changetoxtz1,value81,changetoeth1,value859,changetosol1,theme,value8591,changetoetc1,changetodark,value1008,value10091,value10092,bg1,value10081,value10082,value10083,changetolight,value10085,logo_value,value10087,value10088,value100910,value10059,value100912,value10057,changetologin,changetosignup})=>{
    ...
    return(
        ...
        <Col className='col-md-3 d-flex justify-content-center align-items-center flex-row' > <a className="btn45 mt-1 me-2 f6 grow no-underline ba bw1 ph2 pv1 mb1 dib b text-white pt-1">поиск</a>
        <input id="name" placeholder='Ваш идентификатор заказа' className="b input-reset ba b--black-20 pt-2 pb-2 ps-2 db w-75" type="text" aria-describedby="name-desc" /> </Col>
        ...
        <Navbar bg={theme} expand="lg" className='navbar1'>
                    <Container>
                        ...
                        <Nav.Link href="#home" style={{'color':`${value1008}`}} className='d-flex justify-content-center align-items-center navlink'>Кошельки <img src={require(`${value10091}`)}   className='ms-2' width={'17px'}/>
                        <span className="b span45 d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}}>рабочий</span>
                        </Nav.Link>
                        <Nav.Link href="#home" style={{'color':`${value1008}`}} className='d-flex justify-content-center align-items-center navlink'>Статус системы <img src={require(`${value10091}`)} className='ms-2' width={'17px'}/>
                        <span className="b span45 d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}} >рабочий</span></Nav.Link>
                            ...
                            <Nav.Link href="#home" className='d-flex justify-content-center align-items-center navlink'>
                            <Button className='br5 btn_login b shadow-4' onClick={changetologin} >Войти</Button>
                            </Nav.Link>
                            
                            <Nav.Link href="#home" className='d-flex justify-content-center align-items-center navlink'>
                            <Button className='br5 btn-danger b shadow-4' onClick={changetosignup}>регистрация</Button>
                            </Nav.Link>
            ...
            <Row className='tc text-center justify-content-center align-items-center'>
                ...
                <Button className={'btn1 b shadow-3'} style={{'background-color':`${value100912}`, 'color':`${value10059}`, 'border':`${value10057}`} } >Переменная ставка</Button>
                </Col>
            </Row>
            ...
            <article className="mw7 center br3 pa3 pa4-ns mv3 ba b--black-10 shadow-3" style={{'background-color':`${value100910}`,'border':`${value10057}`}} onClick={() => {
				setLgShow(true)
				setLgShow2('ОТПРАВЛЯЕТЕ')
			}}>
                    <img src={require(`./${value10}.png`)}/>
                    <h3 className='b send_r mt-4 mb-1 tc text-center' style={{'color':`${value10059}`}} >ВЫ ОТПРАВЛЯЕТЕ</h3>
                ...
                <article style={{'background-color':`${value100910}`,'border':`${value10057}`}} className="mw7 center br3 pa3 pa4-ns mv3 ba b--black-10 shadow-3" onClick={() => {
					setLgShow3(true)
					setLgShow2('ПОЛУЧАЕТЕ')
				}}>
                <img src={require(`./${value11}.png`)}/>
                <h3 className='b send_r mt-4 mb-1' style={{'color':`${value10059}`}} >ВЫ ПОЛУЧАЕТЕ</h3>
            ...
            <Row className='mt-3'>
            <Col className='col-md-12 text-black'>
            <p style={{'color':`${value10059}`}} className='b para10'>Приемный адрес</p>
                </Col>
            </Row>
            ...
            <Row className='mt-3'>
                <Col className='col-md-12 text-black'>
                <Button className='btn2 b shadow-3' style={{'background-color':`${value100910}`,'border':`${value10057}`,'color':`${value10059}`}}  onClick={call}>ОБМЕН</Button>
                </Col>
            </Row>
      ...
      <h3 className='b tc'>ВЫ {lgShow2} </h3>
      </Col>
      </Row>
      </Modal.Title>
      </Modal.Header>
      <Modal.Body style={{'background-color':`${value100910}`,'color':`${value10059}`}} >
            <Row>
                <Col className='col-md-12 tc text-center'>
                    <p className="b text-black tc text-center para200">Крипто на {lgShow2}</p>
                </Col>
            </Row>
      ...
      <Row>
      <Col className='col-md-12 tc text-center'>
      <h3 className='b tc text-black'>Вы {lgShow2}</h3>
      </Col>
      </Row>
      </Modal.Title>
      </Modal.Header>
        <Modal.Body >
            <Row>
                <Col className='col-md-12 tc text-center'>
                    <p className="b text-black tc text-center para200 mt-0">Крипто на {lgShow2}</p>
                </Col>
            </Row>
            ...
            <h2 className='tc b mt-4 text-center'>Как обменять Крипто</h2>
            <p className='tc text-cente br'>Обмен криптографией прост и прост на Bitbarter</p>
            <p className='tc text-center'>Следуйте четырем шагам</p>
            ...
            <h6>Выберите крипто, которое вы хотите получить</h6>
            </Col>
            <Col className='col-md-3 mt-4 mb-4'>
            ...
            <h6>Введите адрес крипто-кошелек</h6>
            </Col>
            <Col className='col-md-3 mt-4 mb-4'>
            ...
            <h6>Нажмите на биржу</h6>
            </Col>
            <Col className='col-md-3 mt-4 mb-4'>
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" className="mt-3 mb-3 bi bi-cash" viewBox="0 0 16 16">
            <path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/>
            <path d="M0 4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V4zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V6a2 2 0 0 1-2-2H3z"/>
            </svg>
            <h6>Получите ваш крипто в секундах</h6>
            </Col>
            </Row>
            </Col>
            </Row>
